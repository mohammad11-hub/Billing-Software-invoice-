...
$conn = new mysqli("localhost", "root", "", "billing_software");
...
$totalInvoices = mysqli_num_rows($result);
...
$result = $conn->query($sql);
$totalrecipt = mysqli_num_rows($result);

// $resultPayment = $conn->query("SELECT COUNT(*) as total FROM payments");
// $rowPayment = $resultPayment->fetch_assoc();
// $totalPayments = $rowPayment['total'];
...
<!-- Welcome Section -->
<div class="container-fluid py-5 bg-light mb-5 shadow-sm rounded ">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-0"><?php echo $totalInvoices; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-0"><?php echo $totalCustomers; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                        <div class="bg-warning bg-gradient text-white rounded-circle d-inline-flex align-items-center justify-content-center"
                            style="width: 60px; height: 60px;">
                            <i class="bi bi-box fs-2"></i>
                        </div>
                        <h5 class="mt-3 mb-1">Items</h5>
                        <p class="text-muted mb-0"><?php echo $totalItems; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                        <div class="bg-info bg-gradient text-white rounded-circle d-inline-flex align-items-center justify-content-center"
                            style="width: 60px; height: 60px;">
                            <i class="bi bi-cash-coin fs-2"></i>
                        </div>
                        <h5 class="mt-3 mb-1">Payments</h5>
                        <p class="text-muted mb-0"><?php echo $totalrecipt; ?></p>
                    </div>
                </div>
            </div>
        </div>
